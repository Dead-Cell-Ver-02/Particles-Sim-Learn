...
struct _render_config
{
    ...
    std::array<Color, _NUM_PARTICLES_TYPES> _PARTICLE_COLORS = {{{54, 74, 63, 255},
                                                                 {88, 112, 97, 255},
                                                                 {130, 153, 138, 255},
                                                                 {185, 203, 191, 255},
                                                                 {160, 106, 92, 255},
...
struct _simulation_config
{
    ...
    std::array<float, _NUM_PARTICLES_TYPES * _NUM_PARTICLES_TYPES> _INTERACTION_RULES = {{0.20f, 0.10f, 0.80f, 0.80f, -1.10f, -1.10f,
                                                                                          0.10f, 0.20f, 0.80f, 0.80f, -1.10f, -1.10f,
                                                                                          -0.60f, -0.60f, 0.30f, 0.05f, 0.95f, 0.95f,
                                                                                          -0.60f, -0.60f, 0.05f, 0.30f, 0.95f, 0.95f,
                                                                                          1.20f, 1.20f, -0.85f, -0.85f, 0.40f, 0.00f,
                                                                                          1.20f, 1.20f, -0.85f, -0.85f, 0.00f, 0.40f}};
};
